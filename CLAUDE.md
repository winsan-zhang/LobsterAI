...
## Active Technologies
- TypeScript (Node.js >=24 <25), Electron 40.2.1 + OpenClaw (npm package), electron-builder, esbuild (001-openclaw-npm-migration)
- SQLite via sql.js (unchanged) (001-openclaw-npm-migration)

## Recent Changes
- 001-openclaw-npm-migration: Added TypeScript (Node.js >=24 <25), Electron 40.2.1 + OpenClaw (npm package), electron-builder, esbuild
